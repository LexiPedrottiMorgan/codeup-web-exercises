...
//function to see if its positive or negative
...
//function to determine if the input is a number or
function isNumber(number) {
    var parsedNumber = parseFloat(number);
    var isANumber = !isNaN(parsedNumber);
    return isANumber;
}

//variable to enter a number
var enterNumber = confirm("Would you like to enter a number?");


//function that executes if the user says true to entering a number
if (enterNumber) {
    var number = prompt("Please enter a number.");

    //There's a problem here, the numbers say its not a number- working for NaNs
...
function analyzeColor(randomColor) {
    ...
    if (randomColor === "red") {
        ...
        console.log("Blueberries are indigo.");
...
function analyzeColor(userColor) {
    ...
    if (userColor === "red") {
        ...
        console.log("Not a color in the rainbow.");
    }
}
